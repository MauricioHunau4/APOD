...
function InformationAPOD(props : any) {
  ...
  return (<>
    <Box sx={{textAlign:"center", width:"auto", height:"auto", border:" 1px solid grey", padding:"40px", margin:"40px 0 0 0"}}>
        ...
        <Typography sx={{color: "white", padding:"20px 0 0 0"}}>{props.searchExplanation === undefined?props.explanation: props.searchExplanation}</Typography>
    </Box>
    <Box sx={{position:"relative", width:"auto", bottom: -300}}>
      <Typography sx={{color: "white", padding:"20px 0 0 0"}}>
