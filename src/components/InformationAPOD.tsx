...
function InformationAPOD(props : Explanation) {

  let explanation = sessionStorage.getItem("info")

  return (<>
    <Box sx={{textAlign:"center", width:"auto", height:"auto", border:" 1px solid grey", padding:"40px", margin:"40px 0 0 0"}} className="box-information-query">
